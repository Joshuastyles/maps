...
include "server.php";
    ...
    //if points are available, display polygon, if not draw and save the points.
	if(!empty($_POST)){
		Polygon::saveCordinates($_POST['coords']);
	}

	$data = Polygon::getCordinates();
...
<html>
    ...
    <title>Polyon - google maps</title>
     
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
     
    <script src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
     
    <script type="text/javascript" src="polygon(1).min.js"></script>
